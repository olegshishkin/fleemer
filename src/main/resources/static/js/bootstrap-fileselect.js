    ...
    var Fileselect = function (fileInput, options) {
        ...
        this.translations = {
            ...
            'ru': {
                'browse': 'Выбрать файл',
                'rules': {
                    'numberOfFiles': 'Количество загружаемых файлов ограничено [num] файлами',
                    'fileExtensions': 'Файлы ограничены типами: [ext]',
                    'fileSize': 'Размер файла ограничен размером [size]'
                }
            }
        };
        this.init();
